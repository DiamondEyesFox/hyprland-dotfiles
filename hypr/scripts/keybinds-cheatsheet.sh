...
print_two_cols "  ${GREEN}Super D${RESET}               → Dolphin" "  ${GREEN}Super A${RESET}               → Mission Control"
print_two_cols "  ${GREEN}Super Y${RESET}               → Yazi" "  ${GREEN}Mouse Btn 277${RESET}         → Mission Control"
